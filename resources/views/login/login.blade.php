 ...
 <div class="main">
    <div class="content">
    	 <div class="login_panel">
        	...
        	<form action="{{ route('login')}}" method="post" id="member">
        		@csrf
                	<input name="email" type="text" value="{{ old('email') }}" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email Address';}" placeholder="Enter your email Address" required autofocus>
                    ...
                    <input name="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" type="password"   onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}" required>
		   			...
		   			<table>
		   				<tbody>
		   					<tr>
		   						<td>
		   							<div>
		   								<input type="text" name="name" value="User Name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Name';}" >
		   								@if ($errors->has('name'))
		                                    <span class="invalid-feedback" role="alert">
		    						...
		    						<div>
		    							<input type="text" name="email" value="Email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'E-Mail';}">
		    							@if ($errors->has('email'))
		                                    <span class="invalid-feedback" role="alert">
		                                        <strong>{{ $errors->first('email') }}</strong>
		                                    </span>
		    					...
		    					<td>
		    						<div>
						           	...
						           	<div>
						           		<input type="text" name="phone" value="Contact Number" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Contact Number';}">
						           	</div>
